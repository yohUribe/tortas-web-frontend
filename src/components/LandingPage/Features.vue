...
const features = ref([{
  ...
  subTitle: 'Tradición',
  description: 'Donde el pasado se encuentra con el presente en cada sabor'
}, {
  icon: 'flaticon-food-7',
  subTitle: 'Calidad',
  description: 'Sabor y excelencia en cada mordisco'
}, {
  icon: 'flaticon-strawberry',
  subTitle: 'Creatividad',
  description: 'Donde la Imaginación Toma Forma'
}, {
  icon: 'flaticon-food-1',
  subTitle: 'Pasión',
  description: 'Sabor con pasión en cada bocado'
}
])
</script>
...
<template>
  ...
  <div class='features-section'>
    <div class='shape_wrapper shape_one'>
      <div class='shape_inner shape_two' style='background-image: url(/src/assets/images/background/3.jpg);'>
    ...
    <div class='auto-container'>
      <div class='row'>
        ...
        <!-- Feature Block -->
        <div class='feature-block col-lg-3 col-md-6 col-sm-12' v-for='(feature, index) in features' :key='index'>
          <div class='inner-box'>
            <div class='icon-box'>
      ...
      <div class='btn-box'>
        <a href='#' class='theme-btn btn-style-two large'><span></span>Descubre mas<span></span></a>
      </div>
    </div>
  </div>
