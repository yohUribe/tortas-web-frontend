...
const title = ref('Magia en el Pastel')

const description = ref('El arte mágico de la pastelería. Cada pastel es una obra de magia comestible, donde ingredientes se convierten en sueños dulces. Descubre la magia en cada creación.')
</script>
...
<template>
  ...
  <section class='call-to-action'>
    <div class='shape_wrapper shape_one'>
      <div class='shape_inner shape_two' style='background-image: url(/src/assets/images/background/2.jpg);'>
