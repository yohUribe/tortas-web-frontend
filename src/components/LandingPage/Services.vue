...
const title = ref('Nuestras especialidades')
...
<template>
  <!-- Services Section -->
  <section class='services-section' style='background-image: url(/src/assets/images/background/1.jpg);'>
    <div class='auto-container'>
      ...
      <div class='services-carousel owl-carousel owl-theme'>
        <!-- Service Block -->
        <div class='service-block' v-for='(service, index) in props.services' :key='index'>
          <div class='inner-box'>
            <div class='image-box'>
              ...
              <!-- cake img -->
              <figure class='image'><img :src=service.data.img alt=''></figure>
            </div>
            <h3>{{service.data.subTitle}}</h3>
